...
def main():
    ...
    parser.add_argument('--log_files', type=str, nargs='+', default=[
                                                                      # '../data/sarl/output.log',
                                                                      # '../data/cbf_rl/output.log',
                                                                      # '../data/ssa_rl/output.log',
                                                                      # '../data/usl/output.log',
                                                                      '../data/hesrl/output.log'
                                                                    ])
    ...
    for i, log_file in enumerate(args.log_files):
        ...
        train_pattern = (r"TRAIN in episode (.*) has success rate: (.*), collision rate: (.*), nav time: (.*), "
                         r"total reward: (.*)")
        train_episode = []
        train_sr = []
        train_cr = []
